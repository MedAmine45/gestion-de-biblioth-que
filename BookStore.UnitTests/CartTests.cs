...
namespace BookStore.UnitTests
{
    ...
    public class CartTests
    {
        ...
        {
            //Arrange
            Book b1 = new Book { BookId = 1, Title = "ASP.NET" };
            Book b2 = new Book { BookId = 2, Title = "Oracle" };
            //Act
        ...
        public void Can_Remove_Line()
        {
            ...
            Book b1 = new Book { BookId = 1, Title = "ASP.NET" };
            Book b2 = new Book { BookId = 2, Title = "Oracle" };
            Book b3 = new Book { BookId = 3, Title = "C#" };
            //Act
            Cart target = new Cart();
            target.AddItem(b1);
            target.AddItem(b2, 3);
        ...
        {
            //Arrange
            Book b1 = new Book { BookId = 1, Title = "ASP.NET" ,Price=100M};
            Book b2 = new Book { BookId = 2, Title = "Oracle" ,Price=50M };
            Book b3 = new Book { BookId = 3, Title = "C#",Price= 70M };
            //Act
            Cart target = new Cart();
            target.AddItem(b1);
            target.AddItem(b2, 2);
        ...
        public void Can_Add_To_Cart()
        {
            ...
            mock.Setup(m => m.Books).Returns(
                new Book[]
                {
                    new Book {BookId = 1, Title="ASP.NET MVC",Specialization="Programming" }
                }.AsQueryable()
                );
            Cart cart = new Cart();
